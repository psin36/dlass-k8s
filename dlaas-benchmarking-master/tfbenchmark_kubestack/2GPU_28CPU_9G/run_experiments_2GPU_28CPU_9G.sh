...
do 
  for batchsize in $batch_sizes
    do 
      out1=${resultdir}V100_${gpus}GPU_28CPU_9G_${framework}_${model}_${batchsize}_gpu_usage.txt
      out2=${resultdir}V100_${gpus}GPU_28CPU_9G_${framework}_${model}_${batchsize}.log 
      echo $out1 $out2
