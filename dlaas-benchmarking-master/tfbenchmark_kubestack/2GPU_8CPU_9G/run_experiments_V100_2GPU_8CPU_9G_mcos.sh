...
do 
  for batchsize in $batch_sizes
    do 
      out1=${resultdir}V100_${gpus}GPU_8CPU_9G_mcos_${framework}_${model}_${batchsize}_gpu_usage.txt
      out2=${resultdir}V100_${gpus}GPU_8CPU_9G_mcos_${framework}_${model}_${batchsize}.log 
      echo $out1 $out2
